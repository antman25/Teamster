...
protocol TeamsterFeedCardCollectionViewCellDelegate: class {
  func showProfile(_ author: TeamsterFeedPost)
  func viewComments(_ post: TeamsterFeedPost)
  func toogleLike(_ post: TeamsterFeedPost, button: UIButton, label: UILabel)
  func deletePost(_ post: TeamsterFeedPost, completion: (() -> Swift.Void)? )
}

class TeamsterFeedCardCollectionViewCell: MDCCollectionViewCell {
  ...
  var post: TeamsterFeedPost!
  weak var delegate: TeamsterFeedCardCollectionViewCellDelegate?
  ...
  func populateContent(post: TeamsterFeedPost, isDryRun: Bool) {
    self.post = post
